...
- Set "profile: "rag_research"" for anything answered from the indexed knowledge base — you have no direct knowledge-base tools, so this fork is the only way to reach it. Use the default "general" profile (or null) for open-web research.
